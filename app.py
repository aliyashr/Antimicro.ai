...
testing = option_menu(
    menu_title=None,
    options=["Home", "About the Atlas/Pfizer dataset", "Sub-group analysis" , "AI Antibacterial Predictor" , "AI Antibacterial Predictor (Genotypic data)", "AI Antifungal Predictor", "Build your own AI model" ],
    icons=["house","info", "info" ,"calculator","calculator","calculator" ,"bricks"],
...
# Fill NaN values with a custom representation (e.g., '-')
...
if testing == "About the Atlas/Pfizer dataset":
    st.title('About the Atlas/Pfizer dataset')
    ...
    st.subheader("Matrix of the Antibacterial dataset with analysis of Missing values")
...
if testing == "Sub-group analysis":
    ...
    st.image("logos/MRSA.gif")
    st.subheader("Antibiotic Families")
    st.image("logos/antibiotics.png")
    st.subheader("Bacterial Species")
    st.image("logos/species.png")
    st.subheader("Minimum Inhibitory Concentration Interpretation")
    st.image("logos/mic.png")
